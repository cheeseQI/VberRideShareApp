...
SECRET_KEY = 'django-insecure-hasu@s-*!o(!zfwy!6_v!$ryrt_=ubld1s-y9%%5b_ii8h+hy$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['web', 'vcm-30653.vm.duke.edu']
...
# email setting, we use a new registered email to be the official email account
